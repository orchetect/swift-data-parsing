//
//  InoutDataParser UInt8 Array Tests.swift
...
@Suite
struct InoutDataParser_UInt8Array_Tests {
    ...
    @Test
    func withInoutDataParser() throws {
        var data: [UInt8] = [0x01, 0x02, 0x03, 0x04]
    ...
    @Test
    func withInoutDataParser_ReturnsValue() throws {
        var data: [UInt8] = [0x01, 0x02, 0x03, 0x04]
