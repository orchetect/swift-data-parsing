//
//  CopyingDataReader DataProtocol Tests.swift
...
@Suite struct CopyingDataReader_DataProtocol_Tests {
    @Test
    ...
    func readGenericData<D: DataProtocol & Sendable>(data: inout D) async throws {
