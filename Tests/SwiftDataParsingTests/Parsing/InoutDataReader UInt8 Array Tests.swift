//
//  InoutDataReader UInt8 Array Tests.swift
...
@Suite struct InoutDataReader_UInt8Array_Tests {
    ...
    func read() async throws {
        ...
        data.withInoutDataReader { dr in
    ...
    @Test
    func withInoutDataReader() async throws {
        var data: [UInt8] = [0x01, 0x02, 0x03, 0x04]
    ...
    @Test
    func withInoutDataReader_ReturnsValue() async throws {
        var data: [UInt8] = [0x01, 0x02, 0x03, 0x04]
