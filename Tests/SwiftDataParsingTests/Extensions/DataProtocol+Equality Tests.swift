...
@Suite
struct DataProtocol_Equality_Tests {
    // MARK: - lhs: [UInt8]

    /// DataProtocol == Data
    @Test
    func uInt8Array_equalTo_data() {
    ...
    /// DataProtocol == Data
    @Test
    func uInt8Array_equalTo_subData() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
    ...
    @Test
    func uInt8Array_equalTo_uInt8Array() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
    ...
    @Test
    func uInt8Array_equalTo_uInt8ArraySlice() {
    ...
    @Test
    func uInt8Array_equalTo_uInt8BufferPointer() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
    ...
    @Test
    func uInt8Array_equalTo_uInt8BufferPointerSlice() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
        let data = Data([0x00, 0x01, 0x02, 0x03, 0x04])
    ...
    /// DataProtocol == Data
    @Test
    func uInt8ArraySlice_equalTo_data() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
    ...
    /// DataProtocol == Data
    @Test
    func uInt8ArraySlice_equalTo_subData() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
        let slice: ArraySlice<UInt8> = array[1 ... 2]
    ...
    /// DataProtocol == [UInt8]
    @Test
    func uInt8ArraySlice_equalTo_uInt8Array() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
        let slice: ArraySlice<UInt8> = array[1 ... 2]
    ...
    /// (built-in, not testing package code)
    @Test
    func uInt8ArraySlice_equalTo_uInt8ArraySlice() {
    ...
    /// DataProtocol == UnsafeBufferPointer<UInt8>
    @Test
    func uInt8ArraySlice_equalTo_uInt8BufferPointer() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
        let slice: ArraySlice<UInt8> = array[1 ... 2]
    ...
    /// DataProtocol == Slice<UnsafeBufferPointer<UInt8>>
    @Test
    func uInt8ArraySlice_equalTo_uInt8BufferPointerSlice() {
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
        let slice: ArraySlice<UInt8> = array[1 ... 2]
    ...
    /// DataProtocol == ArraySlice<UInt8>
    @Test
    func data_equalTo_uInt8ArraySlice() {
        let data = Data([0x01, 0x02, 0x03, 0x04])
    ...
    /// DataProtocol == UnsafeBufferPointer<UInt8>
    @Test
    func data_equalTo_uInt8BufferPointer() {
        let data1 = Data([0x01, 0x02, 0x03, 0x04])
        let data2 = Data([0x01, 0x02, 0x03, 0x04])
    ...
    /// DataProtocol == Slice<UnsafeBufferPointer<UInt8>>
    @Test
    func data_equalTo_uInt8BufferPointerSlice() {
        let data1 = Data([0x01, 0x02, 0x03, 0x04])
        let data2 = Data([0x00, 0x01, 0x02, 0x03, 0x04])
        data2.withContiguousStorageIfAvailable { data2Buffer in
    ...
    /// DataProtocol == Data
    @Test
    func uInt8BufferPointer_equalTo_data() {
        let data = Data([0x01, 0x02, 0x03, 0x04])
        data.withContiguousStorageIfAvailable { buffer in
    ...
    /// DataProtocol == Data
    @Test
    func uInt8BufferPointer_equalTo_subData() {
        let data = Data([0x01, 0x02, 0x03, 0x04])
    ...
    /// DataProtocol == [UInt8]
    @Test
    func uInt8BufferPointer_equalTo_uInt8Array() {
        let data = Data([0x01, 0x02, 0x03, 0x04])
        let array: [UInt8] = [0x01, 0x02, 0x03, 0x04]
        data.withContiguousStorageIfAvailable { buffer in
            #expect(buffer == array)
    ...
    /// DataProtocol == ArraySlice<UInt8>
    @Test
    func uInt8BufferPointer_equalTo_uInt8ArraySlice() {
        let data = Data([0x01, 0x02, 0x03, 0x04])
    ...
    /// DataProtocol == UnsafeBufferPointer<UInt8>
    @Test
    func uInt8BufferPointer_equalTo_uInt8BufferPointer() {
        let data1 = Data([0x01, 0x02, 0x03, 0x04])
        let data2 = Data([0x01, 0x02, 0x03, 0x04])
    ...
    /// DataProtocol == Slice<UnsafeBufferPointer<UInt8>>
    @Test
    func uInt8BufferPointer_equalTo_uInt8BufferPointerSlice() {
        let data1 = Data([0x01, 0x02, 0x03, 0x04])
        let data2 = Data([0x00, 0x01, 0x02, 0x03, 0x04])
