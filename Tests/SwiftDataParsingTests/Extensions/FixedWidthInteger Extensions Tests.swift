...
struct FixedWidthInteger_Extensions_Tests {
    @Test
    func signBit() {
        #expect(UInt8(0b00000000).signBit == 0)
        #expect(UInt8(0b10000000).signBit == 1)

        #expect(UInt16(0b00000000_00000000).signBit == 0)
        #expect(UInt16(0b10000000_00000000).signBit == 1)
    ...
    @Test
    func signBitMask() {
        #expect(UInt8.signBitMask == 0b10000000)

        #expect(UInt16.signBitMask == 0b10000000_00000000)
    ...
    @Test
    func nonSignBits() {
        #expect(UInt8(0b00000000).nonSignBits == 0)
        #expect(UInt8(0b10000000).nonSignBits == 0)
        #expect(UInt8(0b01111111).nonSignBits == 0b01111111)
        #expect(UInt8(0b11111111).nonSignBits == 0b01111111)

        #expect(UInt16(0b00000000_00000000).nonSignBits == 0)
        #expect(UInt16(0b10000000_00000000).nonSignBits == 0)
        #expect(UInt16(0b01111111_11111111).nonSignBits == 0b01111111_11111111)
        #expect(UInt16(0b11111111_11111111).nonSignBits == 0b01111111_11111111)
    ...
    func nonSignBitsMask() {
        #expect(UInt8.nonSignBitsMask == 0b01111111)

        #expect(UInt16.nonSignBitsMask == 0b01111111_11111111)
