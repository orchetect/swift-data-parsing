...
@Suite struct SignedInteger_Encoding_Tests {
    ...
    @Test
    func uInt8_encoding_signedBit() async {
    ...
    @Test
    func uInt8_encoding_onesComplement() async {
    ...
    @Test
    func uInt16_encoding_signedBit() async {
    ...
    @Test
    func uInt16_encoding_onesComplement() async {
